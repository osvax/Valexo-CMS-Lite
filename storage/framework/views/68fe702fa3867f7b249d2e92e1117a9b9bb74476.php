...
<?php $__env->startPush('styles_after'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('vendor/colorbox/colorbox.css')); ?>">
<?php $__env->stopPush(); ?>
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-1">
                                    <!-- text input -->
                                    <div class="form-group">
                                        <label id="order"><?php echo e(__('admin.order')); ?></label>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script src="<?php echo e(asset('vendor/colorbox/jquery.colorbox-min.js')); ?>"></script>
        <script src="<?php echo e(asset('packages/barryvdh/elfinder/js/standalonepopup.js')); ?>"></script>
        <script src="<?php echo e(asset('/vendor/ckeditor/ckeditor.js')); ?>"></script>
        <script src="<?php echo e(asset('vendor/codemirror/lib/codemirror.js')); ?>"></script>
        <script src="<?php echo e(asset('vendor/codemirror/javascript/javascript.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OSPanel\DEVELOPMENT\VALEXO\lite\admin/page/create.blade.php ENDPATH**/ ?>