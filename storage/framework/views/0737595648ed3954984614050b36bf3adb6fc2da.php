<nav class="topnav navbar navbar-expand   <?php if(config('valexo.navbar_class')): ?> <?php echo e(config('valexo.navbar_class')); ?> <?php endif; ?>" id="sidenavAccordion">
    <!-- Navbar Brand-->
    <!-- * * Tip * * You can use text or an image for your navbar brand.-->
    <!-- * * * * * * When using an image, we recommend the SVG format.-->
    <!-- * * * * * * Dimensions: Maximum height: 32px, maximum width: 240px-->
    <a class="navbar-brand" href="<?php echo e(route('admin.dashboard.index')); ?>" style="font-size: 1.6em;"> <span style="border-radius:5px;padding: 2px;">VALEXO</span> <span style="background:deepskyblue;padding: 6px;color: #FFFFFF; border-radius:5px ;position:relative;">CMS<sup style="position:absolute;top:28px;right:5px;color:black;font-size: 12px;">Lite</sup></span></a>
    ...
    <ul class="navbar-nav align-items-center ml-auto">
        ...
        <li class="nav-item dropdown no-caret d-none d-sm-block mr-3 dropdown-notifications">
            ...
            <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownMessages">
                ...
                <!-- Example Message 1  -->
                <a class="dropdown-item dropdown-notifications-item" href="starter-default.html#!">
                    <img class="dropdown-notifications-item-img" src="<?php echo e(asset("access/img/illustrations/profiles/profile-2.png")); ?>" />
                    <div class="dropdown-notifications-item-content">
                ...
                <!-- Example Message 2-->
                <a class="dropdown-item dropdown-notifications-item" href="starter-default.html#!">
                    <img class="dropdown-notifications-item-img" src="<?php echo e(asset("access/img/illustrations/profiles/profile-3.png")); ?>" />
                    <div class="dropdown-notifications-item-content">
                        <div class="dropdown-notifications-item-content-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
                ...
                <!-- Example Message 3-->
                <a class="dropdown-item dropdown-notifications-item" href="starter-default.html#!">
                    <img class="dropdown-notifications-item-img" src="<?php echo e(asset("access/img/illustrations/profiles/profile-4.png")); ?>" />
                    <div class="dropdown-notifications-item-content">
                        <div class="dropdown-notifications-item-content-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
                ...
                <!-- Example Message 4-->
                <a class="dropdown-item dropdown-notifications-item" href="starter-default.html#!">
                    <img class="dropdown-notifications-item-img" src="<?php echo e(asset("access/img/illustrations/profiles/profile-5.png")); ?>" />
                    <div class="dropdown-notifications-item-content">
                        <div class="dropdown-notifications-item-content-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
        ...
        <li class="nav-item dropdown no-caret mr-3 mr-lg-0 dropdown-user">
            <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="img-fluid" src="<?php echo e(asset("access/img/illustrations/profiles/profile-1.png")); ?>" /></a>
            <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                <h6 class="dropdown-header d-flex align-items-center">
                    <img class="dropdown-user-img" src="<?php echo e(asset("access/img/illustrations/profiles/profile-1.png")); ?>" />
                    <div class="dropdown-user-details">
                        <div class="dropdown-user-details-name"><?php echo e(Auth::user()->name); ?></div>
                        <div class="dropdown-user-details-email"><a href="mailto:<?php echo e(Auth::user()->email); ?>"><?php echo e(Auth::user()->email); ?></a></div>
                    </div>
                </h6>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item"  target="_blank" href="<?php echo e(route('index.controller')); ?>">
                    <div class="dropdown-item-icon"><i class="fas fa-globe-americas"></i></div>
                    <?php echo e(__('messages.tosite')); ?>

                </a>
                <a class="dropdown-item" href="<?php echo e(route('admin.dashboard.index')); ?>">
                    <div class="dropdown-item-icon"><i data-feather="settings"></i></div>
                    <?php echo e(__('messages.acount')); ?>
...
<?php /**PATH E:\OSPanel\DEVELOPMENT\VALEXO\lite\admin/navigation.blade.php ENDPATH**/ ?>