...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function get_num($ip)
        {
                        /** @var \Eseath\SxGeo\SxGeo $instance */
                        return $instance->get_num($ip);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Eseath\SxGeo\SxGeo $instance */
                        return $instance->getCountryId($ip);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getCityFull($ip)
        {
                        /** @var \Eseath\SxGeo\SxGeo $instance */
                        return $instance->getCityFull($ip);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class Eseath extends \Eseath\SxGeo\SxGeoServiceProvider {}
            class SxGeo extends \Eseath\SxGeo\Facades\SxGeo {}
